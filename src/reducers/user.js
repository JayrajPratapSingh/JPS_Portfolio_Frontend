...
export const updateUserReducer = createReducer({}, {
    ...
    ADD_TIMELINE_SUCESS:(state, action)=>{
        state.loading = false;
        state.message = action.payload;
    },
    ...
    DELETE_TIMELINE_SUCESS:(state, action)=>{
        state.loading = false;
        state.message = action.payload;
    },
    ...
    ADD_YOUTUBE_SUCESS:(state, action)=>{
        state.loading = false;
        state.message = action.payload;
    },
    ...
    DELETE_YOUTUBE_SUCESS:(state, action)=>{
        state.loading = false;
        state.message = action.payload;
    },
    ...
    ADD_PROJECT_SUCESS:(state, action)=>{
        state.loading = false;
        state.message = action.payload;
    },
    ...
    DELETE_PROJECT_SUCESS:(state, action)=>{
        state.loading = false;
        state.message = action.payload;
    },
    ...
    CONTACT_US_SUCESS:(state, action)=>{
        state.loading = false;
        state.message = action.payload;
    },
